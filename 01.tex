...
\quad
\subfigure[接收]{
\includegraphics[width=15cm]{pic/ch2/code-Server3.JPG}
}
...
\quad
\subfigure[傳送]{
\includegraphics[width=7cm]{pic/ch2/code-Client2.JPG}
\includegraphics[width=7cm]{pic/ch2/code-Client3.JPG}
}
\quad
\subfigure[接收]{
\includegraphics[width=15cm]{pic/ch2/code-Client4.JPG}
}
